...
import type { FormInstanceFunctions, FormRule, PageInfo, SelectOption } from 'tdesign-vue-next';
...
import {
  ...
  resolveDocumentNoPlaceholder,
  resolveOrgUnitType,
  type AreaOption,
  type OrgUnitNode,
  validateDocumentNumber,
} from '@/views/system/user/helpers';
import { useUserDialog } from '@/views/system/user/hooks/useUserDialog';
import { createResetPasswordForm, createUserForm } from '@/views/system/user/hooks/useUserForm';
import { createUserColumns, createUserFilters, createUserPagination } from '@/views/system/user/hooks/useUserTable';
import { useUserStore } from '@/store';
import { buildDictOptions, parseDictValue } from '@/utils/dict';
import { hasPerm } from '@/utils/permission';
import { request } from '@/utils/request';
import type { PageResult, RoleRow, UserRow } from '@/views/system/user/schema';
...
const { drawerVisible, mode, editingId, resetDialogVisible, resetSubmitting, resetTarget, drawerTitle } =
  useUserDialog();
...
const resetPasswordForm = createResetPasswordForm();
...
const handleOrgSelect = (ctx: any) => {
  ...
  if (nodeType === 'DEPARTMENT' || nodeType === 'SECTION' || nodeType === 'TEAM') {
