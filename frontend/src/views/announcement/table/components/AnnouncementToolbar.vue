<template>
  <t-space style="flex-wrap: wrap; margin-bottom: 24px" size="24px">
    ...
    <t-select :model-value="query.status" clearable :options="statusOptions" placeholder="公告状态" style="width: 160px" @update:model-value="emitUpdate('status', $event)" />
    ...
    <t-button theme="primary" :disabled="!canCreate" @click="$emit('create')">新增公告</t-button>
  </t-space>
</template>
