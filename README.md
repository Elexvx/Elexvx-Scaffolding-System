...
- 其他：Flyway（默认启用，用于数据库版本迁移治理）、AJ Captcha
...
- 正式方式：通过 Flyway 自动迁移（`backend/src/main/resources/db/migration/**`）
- 历史脚本：`database/tdesign_init.sql`、`database/tdesign_init_pg.sql`、`database/tdesign_init_oracle.sql`、`database/tdesign_init_sqlserver.sql` 仅作参考或手工排障资料
...
- 数据库迁移治理：`docs/refactor/database-migration.md`
