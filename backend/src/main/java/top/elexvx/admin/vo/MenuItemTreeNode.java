...
public class MenuItemTreeNode {
  ...
  private List<MenuItemTreeNode> children;
  ...
  public List<MenuItemTreeNode> getChildren() {
    return children;
  }

  public void setChildren(List<MenuItemTreeNode> children) {
    this.children = children;
  }

  public void addChild(MenuItemTreeNode child) {
