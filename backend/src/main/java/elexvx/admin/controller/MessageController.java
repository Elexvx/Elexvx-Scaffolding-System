...
public class MessageController {
  ...
  @RepeatSubmit
  public ApiResponse<Integer> broadcast(@RequestBody @Validated elexvx.admin.dto.AnnouncementRequest req) {
