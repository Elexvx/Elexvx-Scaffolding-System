...
public class MessageController {
  ...
  @RepeatSubmit
  public ApiResponse<Integer> broadcast(@RequestBody @Validated top.elexvx.admin.dto.AnnouncementRequest req) {
