...
- MySQL 可导入 `database/tdesign_init.sql` 作为初始结构与示例数据
- PostgreSQL / Oracle / SQL Server 分别可导入 `database/tdesign_init_pg.sql`、`database/tdesign_init_oracle.sql`、`database/tdesign_init_sqlserver.sql`
