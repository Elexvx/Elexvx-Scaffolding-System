...
import top.elexvx.admin.dto.UserIdLongValue;
import top.elexvx.admin.dto.UserIdStringValue;
...
import top.elexvx.admin.mapper.UserDepartmentMapper;
import top.elexvx.admin.mapper.UserMapper;
import top.elexvx.admin.mapper.UserOrgUnitMapper;
...
import top.elexvx.admin.annotation.AiFunction;
...
public class UserAdminService {
  ...
  public UserAdminService(
    ...
    @Value("${elexvx.user.guid.backfill-on-startup:false}") boolean guidBackfillOnStartup
  ) {
